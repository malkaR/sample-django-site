...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoogleQuery.created_on'
        db.add_column(u'core_googlequery', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 6, 30, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'GoogleSuggestion.suggestions'
        db.delete_column(u'core_googlesuggestion', 'suggestions')

        # Adding field 'GoogleSuggestion.created_on'
        db.add_column(u'core_googlesuggestion', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 6, 30, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoogleQuery.created_on'
        db.delete_column(u'core_googlequery', 'created_on')


        # User chose to not deal with backwards NULL issues for 'GoogleSuggestion.suggestions'
        raise RuntimeError("Cannot reverse this migration. 'GoogleSuggestion.suggestions' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'GoogleSuggestion.suggestions'
        db.add_column(u'core_googlesuggestion', 'suggestions',
                      self.gf('django.db.models.fields.TextField')(),
                      keep_default=False)

        # Deleting field 'GoogleSuggestion.created_on'
        db.delete_column(u'core_googlesuggestion', 'created_on')
