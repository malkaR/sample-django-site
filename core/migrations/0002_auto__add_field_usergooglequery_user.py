...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserGoogleQuery.user'
        db.add_column(u'core_usergooglequery', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserGoogleQuery.user'
        db.delete_column(u'core_usergooglequery', 'user_id')
